...
import { FiArrowLeft, FiPlus, FiTrash2, FiLoader, FiUploadCloud } from 'react-icons/fi';
...
const EditProduct = () => {
  ...
  return (
    <div className="container section-padding" style={{ paddingTop: '40px' }}>
      ...
      <h1 style={{ fontSize: '2rem', marginBottom: '30px' }}>Edit Product</h1>
